...
Think of it as a way to play animations and sounds in software without any specific bells and whistles.

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Known issues

This project is delivered as is (like the others). It has only been tested and configured for Windows in DEBUG mode in the current version.

* The sounds made by the cow and the buffalo are a little too similar.
* Two more animals need to be added to complete the 9-square grid.
* The images should be the same size and centered on the buttons.
* The animations do not play correctly because the spritesheets used are not properly formatted for automated cutting.
* For use outside of Delphi, the paths to the sound files must be recalculated in the program based on their position when the software is deployed.

## Using this video game

Visit [the Boite à Meuh website](https://boiteameuh.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/BoiteAMeuh) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://boiteameuh.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/boite-a-meuh.html).
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://boiteameuh.gamolf.fr).
